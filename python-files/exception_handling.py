...
# #write a custom exception for a ugandan to drive a car
...
try:
    ...
    if age < 18:
        raise UgandanCannotDriveException("You are not allowed to drive a car in Uganda.")
    else:
        print("You are allowed to drive a car in Uganda.")
except UgandanCannotDriveException as e:
    print(e)
